...
# 리뷰 중에 이모티콘이 있ㅇ르 경우 다른 글자나 이미지로 변경해서 저장하도록 미리 조치
...
if cnt < 51 :
        ...
        #driver.find_element_by_xpath('''//*[@id="zg-center-div"]/div[3]/div/ul/li[3]/a''').click()
...
amazon_best_seller['상풍평점'] = pd.Series(score2)
